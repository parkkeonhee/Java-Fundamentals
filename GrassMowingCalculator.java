...
public class GrassMowingCalculator {
	...
	private GrassMowingCalculator(double yardL, double yardW, double houseL, double houseW) {
		lengthYard = yardL;
		widthYard = yardW;
		lengthHouse = houseL;
		widthHouse = houseW;
	...
	public static void main(String[] args) {
		...
		GrassMowingCalculator myHouse = new GrassMowingCalculator(yardL, yardW, houseL, houseW);
